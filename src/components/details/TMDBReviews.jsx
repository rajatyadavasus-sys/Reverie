...
const ReviewCard = ({ review, isCurrentUser = false, isReverieUser = false }) => {
  ...
  const avatarUrl = isPlatformUser
    ? ((isCurrentUser ? currentUser?.photoURL : review.photoURL) || `https://api.dicebear.com/7.x/adventurer/svg?seed=${encodeURIComponent(emailForAvatar)}&backgroundColor=transparent`)
